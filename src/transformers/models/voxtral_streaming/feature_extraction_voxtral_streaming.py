...
class VoxtralStreamingFeatureExtractor(SequenceFeatureExtractor):
    r"""
    Constructs a VOXTRAL_STREAMING feature extractor.
...
__all__ = ["VoxtralStreamingFeatureExtractor"]
